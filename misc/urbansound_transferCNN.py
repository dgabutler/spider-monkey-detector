...
df = np.zeros(shape=(25000,2), dtype=object) # dataset
...
for row in valid_data.itertuples():
    job_idx += 1
    try:
        file_name = '../Data/UrbanSound8K/audio/' + row.path
    except IOError: continue
    y, sr = sf.read(file_name, stop=132300) 
    ...
    if df_idx % 10 == 0:
        print(str(df_idx)+' ('+str(round(df_idx/24500, 3))+'%)', end='\r')
    # increment dataframe index if value added
    df_idx += 1  
np.save('../Data/UrbanSound8K/unaugmented-df.npy', df) 
...
for row in valid_data.itertuples():
    ...
    # increment dataframe index if value added
    df_idx += 1  
np.save('../Data/UrbanSound8K/aug1-df.npy', df) 
...
for row in valid_data.itertuples():
    ...
    # increment dataframe index if value added
    df_idx += 1  
np.save('../Data/UrbanSound8K/aug2-df.npy', df) 
...
for row in valid_data.itertuples():
    ...
    # increment dataframe index if value added
    df_idx += 1  
np.save('../Data/UrbanSound8K/aug3-df.npy', df) 
...
for row in valid_data.itertuples():
    ...
    # increment dataframe index if value added
    df_idx += 1  
np.save('../Data/UrbanSound8K/aug4-df.npy', df) 
